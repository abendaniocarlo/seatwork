...
<form role="form" class="" method="post" action="<?php echo base_url('sms/save?a=edit'); ?>" >
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="lname" name="lname" value="<?php echo $students[0]['lname']; ?>"/>
				</div>	
				<div class="form-group">
					<label for="fname">First Name:</label>
					<input type="text" class="form-control" id="fname" name="fname" value="<?php echo $students[0]['fname']; ?>"/>
				</div>
				<div class="form-group">
					<label for="mname">Middle Name:</label>
					<input type="text" class="form-control" id="mname" name="mname" value="<?php echo $students[0]['mname']; ?>"/>
				</div>
				<div class="form-group">
